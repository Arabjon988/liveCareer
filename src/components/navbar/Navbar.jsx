        ...
        <div className="navbar_main">
          ...
          <div className={menu ? "navbar_main_links nav_active" : "navbar_main_links"}>
            ...
            <div className="navbar_main_links_div">
              <Link to='/resume' className='navbar_main_link'>RESUMES <MdKeyboardArrowDown className='navbar_main_link_icon'/></Link>
            ...
            <div className="navbar_main_links_div">
              <Link to='/cv' className='navbar_main_link'>CV <MdKeyboardArrowDown className='navbar_main_link_icon'/></Link>
              <div className="navbar_main_links_div1">
            ...
            <div className="navbar_main_links_div">
              <Link to='/coverLetter' className='navbar_main_link'>COVER LETTERS <MdKeyboardArrowDown className='navbar_main_link_icon'/></Link>
              <div className="navbar_main_links_div1">
            ...
            <Link to='/question' className='navbar_main_link'>QUESTIONS</Link>
            <Link to='/resource' className='navbar_main_link'>RESOURCES</Link>
            <div className="navbar_main_links_div">
